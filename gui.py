...
class App(QMainWindow):
    ...
    def __init__(self):
        ...
        #SSD7 parameters
        self.model_mode = 'inference_fast'
        self.img_height = 300  # Height of the input images
        self.img_width = 300  # Width of the input images
        ...
        self.n_classes = 3  # Number of positive classes
        self.scales = [0.08, 0.16, 0.32, 0.64, 0.96]  # An explicit list of anchor box scaling factors. If this is passed, it will override `min_scale` and `max_scale`.
        self.aspect_ratios = [0.5, 1.0, 2.0]  # The list of aspect ratios for the anchor boxes
        self.two_boxes_for_ar1 = True  # Whether or not you want to generate two anchor boxes for aspect ratio 1
